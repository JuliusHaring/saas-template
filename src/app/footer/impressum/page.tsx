...
export default function Impressum() {
  return (
    <>
      ...
      <div>
        <Headline level={2} block className="my-4">Diensteanbieter</Headline>
        Angaben gemäß § 5 TMG:
        <br />
      ...
      <div>
        <Headline level={2} block className="my-4">Kontaktmöglichkeiten</Headline>
        E-Mail-Adresse:{" "}
        <a href="mailto:info@juliusharing.com">info@juliusharing.com</a>
      </div>

      <div>
        <Headline level={2} block className="my-4">Vertretungsberechtigte</Headline>
        Vertretungsberechtigt: Julius Haring
      </div>

      <div>
        <Headline level={2} block className="my-4">Angaben zum Unternehmen</Headline>
      ...
      <div>
        <Headline level={2} block className="my-4">Online-Streitbeilegung (OS)</Headline>
      ...
      <div>
        <Headline level={2} block className="my-4">Haftungs- und Schutzrechtshinweise</Headline>
        ...
        Inhalte vollständig oder teilweise zu ändern oder zu löschen, soweit
        vertragliche Verpflichtungen unberührt bleiben. Alle Angebote sind
        freibleibend und unverbindlich.
      </div>

      <div>
        <Headline level={2} block className="my-4">Verantwortlicher</Headline>
        Julius Haring
        <br />
        E-Mail-Adresse:{" "}
        <a href="mailto:info@juliusharing.com">info@juliusharing.com</a>
      ...
      <div>
        <Headline level={2} block className="my-4">Ihre Rechte</Headline>
